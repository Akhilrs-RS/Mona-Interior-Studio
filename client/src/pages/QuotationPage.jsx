...
export default function QuotationPage() {
  ...
  return (
    <div className="bg-gray-200 min-h-screen font-sans text-slate-800 flex flex-col">
      ...
      <div className="bg-amber-50 p-2 grid grid-cols-12 gap-2 border-b border-amber-200 items-end text-slate-600">
        <div className="col-span-2">
          ...
          <input
            disabled
            value={quoteNo}
            className="w-full bg-amber-100 border border-amber-200 px-2 py-1 text-sm font-bold text-amber-800 outline-none"
          />
        </div>
        ...
        <div className="col-span-2">
          ...
          <input
            disabled
            value={quoteDate}
            className="w-full bg-amber-100 border border-amber-200 px-2 py-1 text-sm font-bold text-slate-700"
          />
        </div>
        ...
        <div className="col-span-1 flex flex-col items-end justify-end pb-0.5">
          ...
          <tbody className="divide-y divide-gray-200">
            {items.map((item, idx) => (
              <tr key={item.id} className="hover:bg-amber-50">
                ...
                <td className="px-2 py-1 text-right font-black text-amber-700">
      ...
      {/* ── FOOTER ── */}
      <div className="bg-gray-100 p-2 border-t border-gray-300 flex justify-between items-center gap-4">
        {/* Stats */}
        <div className="flex gap-4">
          <div className="bg-amber-50 border border-amber-200 px-3 py-1 flex gap-2 items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="bg-yellow-100 border border-yellow-200 px-10 py-2 rounded shadow-inner text-right min-w-[200px]">
            ...
            <div className="text-5xl font-black text-amber-700 tracking-tighter">
              {subTotal.toFixed(2)}
            </div>
            <div className={`text-[9px] font-black uppercase mt-0.5 ${billType === 'Non-GST' ? 'text-rose-500' : 'text-slate-400'}`}>
              {billType === 'Non-GST' ? 'No Tax Applied (Non-GST)' : 'Exclusive of GST'}
            </div>
          </div>
        </div>
      </div>
