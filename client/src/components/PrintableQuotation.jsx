    ...
    >
      ...
      <table className="w-full border-collapse mb-6 border border-gray-200">
        ...
        <tbody className="text-[11px]">
          ...
          {isNonGST ? (
             <tr className="bg-rose-50 text-rose-700 font-bold italic">
               <td colSpan="5" className="border border-gray-200 p-2 text-center text-[10px] uppercase tracking-widest">
                 ** Non-GST Quotation - No Tax Applied **
               </td>
             </tr>
          ) : (
